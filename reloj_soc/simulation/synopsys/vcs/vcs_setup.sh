...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/reloj_soc_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/reloj_soc_mm_interconnect_0_avalon_st_adapter.v \
  $QSYS_SIMDIR/submodules/reloj_soc_mm_interconnect_0_rsp_mux_001.sv \
  ...
  $QSYS_SIMDIR/submodules/reloj_soc_mm_interconnect_0_cmd_mux_003.sv \
  ...
  $QSYS_SIMDIR/submodules/reloj_soc_mm_interconnect_0_router_005.sv \
  ...
  $QSYS_SIMDIR/submodules/reloj_soc_audio_pll_0.v \
  ...
  $QSYS_SIMDIR/submodules/reloj_soc_audio_and_video_config_0.v \
  ...
  $QSYS_SIMDIR/submodules/reloj_soc_REG_BUTTON.v \
  $QSYS_SIMDIR/submodules/reloj_soc_RAM.v \
  $QSYS_SIMDIR/submodules/reloj_soc_NIOSII.v \
  $QSYS_SIMDIR/reloj_soc.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
