...
module reloj_soc_mm_interconnect_0 (
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                      // cmd_mux_001:src_channel -> UART_avalon_jtag_slave_agent:cp_channel
	...
	wire  [90:0] cmd_mux_006_src_data;                                                         // cmd_mux_006:src_data -> REG_BUTTON_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                        // REG_BUTTON_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                      // cmd_mux_006:src_channel -> REG_BUTTON_s1_agent:cp_channel
	...
	wire         reg_button_s1_agent_rp_valid;                                                 // REG_BUTTON_s1_agent:rp_valid -> router_008:sink_valid
	wire  [90:0] reg_button_s1_agent_rp_data;                                                  // REG_BUTTON_s1_agent:rp_data -> router_008:sink_data
	wire         reg_button_s1_agent_rp_ready;                                                 // router_008:sink_ready -> REG_BUTTON_s1_agent:rp_ready
	wire         reg_button_s1_agent_rp_startofpacket;                                         // REG_BUTTON_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         reg_button_s1_agent_rp_endofpacket;                                           // REG_BUTTON_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         reg_button_s1_agent_rdata_fifo_src_valid;                                     // REG_BUTTON_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] reg_button_s1_agent_rdata_fifo_src_data;                                      // REG_BUTTON_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         reg_button_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> REG_BUTTON_s1_agent:rdata_fifo_src_ready
