...
module reloj_soc_mm_interconnect_0 (
	...
	wire  [93:0] audio_0_avalon_audio_slave_agent_rf_source_data;                                  // audio_0_avalon_audio_slave_agent:rf_source_data -> audio_0_avalon_audio_slave_agent_rsp_fifo:in_data
	...
	wire  [93:0] audio_0_avalon_audio_slave_agent_rsp_fifo_out_data;                               // audio_0_avalon_audio_slave_agent_rsp_fifo:out_data -> audio_0_avalon_audio_slave_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> audio_0_avalon_audio_slave_agent:cp_data
	...
	wire  [93:0] audio_and_video_config_0_avalon_av_config_slave_agent_rf_source_data;             // audio_and_video_config_0_avalon_av_config_slave_agent:rf_source_data -> audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo:in_data
	...
	wire  [93:0] audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo_out_data;          // audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo:out_data -> audio_and_video_config_0_avalon_av_config_slave_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> FIFO_out_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                            // FIFO_out_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [8:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> FIFO_out_agent:cp_channel
	...
	wire         cmd_mux_006_src_valid;                                                            // cmd_mux_006:src_valid -> REG_LEDS_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                             // cmd_mux_006:src_data -> REG_LEDS_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                            // REG_LEDS_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> REG_LEDS_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                    // cmd_mux_006:src_startofpacket -> REG_LEDS_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                      // cmd_mux_006:src_endofpacket -> REG_LEDS_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_008_src_valid;                                                            // cmd_mux_008:src_valid -> REG_BUTTON_s1_agent:cp_valid
	wire  [92:0] cmd_mux_008_src_data;                                                             // cmd_mux_008:src_data -> REG_BUTTON_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                            // REG_BUTTON_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                          // cmd_mux_008:src_channel -> REG_BUTTON_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                    // cmd_mux_008:src_startofpacket -> REG_BUTTON_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                      // cmd_mux_008:src_endofpacket -> REG_BUTTON_s1_agent:cp_endofpacket
	...
	wire  [92:0] audio_0_avalon_audio_slave_agent_rp_data;                                         // audio_0_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [92:0] audio_and_video_config_0_avalon_av_config_slave_agent_rp_data;                    // audio_and_video_config_0_avalon_av_config_slave_agent:rp_data -> router_003:sink_data
	...
	wire         fifo_out_agent_rp_valid;                                                          // FIFO_out_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] fifo_out_agent_rp_data;                                                           // FIFO_out_agent:rp_data -> router_006:sink_data
	wire         fifo_out_agent_rp_ready;                                                          // router_006:sink_ready -> FIFO_out_agent:rp_ready
	wire         fifo_out_agent_rp_startofpacket;                                                  // FIFO_out_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         fifo_out_agent_rp_endofpacket;                                                    // FIFO_out_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         reg_leds_s1_agent_rp_valid;                                                       // REG_LEDS_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] reg_leds_s1_agent_rp_data;                                                        // REG_LEDS_s1_agent:rp_data -> router_008:sink_data
	wire         reg_leds_s1_agent_rp_ready;                                                       // router_008:sink_ready -> REG_LEDS_s1_agent:rp_ready
	wire         reg_leds_s1_agent_rp_startofpacket;                                               // REG_LEDS_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         reg_leds_s1_agent_rp_endofpacket;                                                 // REG_LEDS_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [92:0] reg_button_s1_agent_rp_data;                                                      // REG_BUTTON_s1_agent:rp_data -> router_010:sink_data
	...
	wire         fifo_out_agent_rdata_fifo_src_valid;                                              // FIFO_out_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] fifo_out_agent_rdata_fifo_src_data;                                               // FIFO_out_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         fifo_out_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_004:in_0_ready -> FIFO_out_agent:rdata_fifo_src_ready
	...
	wire         reg_leds_s1_agent_rdata_fifo_src_valid;                                           // REG_LEDS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] reg_leds_s1_agent_rdata_fifo_src_data;                                            // REG_LEDS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         reg_leds_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_006:in_0_ready -> REG_LEDS_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                // avalon_st_adapter_006:out_0_valid -> REG_LEDS_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                 // avalon_st_adapter_006:out_0_data -> REG_LEDS_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                // REG_LEDS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                // avalon_st_adapter_006:out_0_error -> REG_LEDS_s1_agent:rdata_fifo_sink_error
	...
	wire         reg_button_s1_agent_rdata_fifo_src_valid;                                         // REG_BUTTON_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] reg_button_s1_agent_rdata_fifo_src_data;                                          // REG_BUTTON_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         reg_button_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_008:in_0_ready -> REG_BUTTON_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                // avalon_st_adapter_008:out_0_valid -> REG_BUTTON_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                 // avalon_st_adapter_008:out_0_data -> REG_BUTTON_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                // REG_BUTTON_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                // avalon_st_adapter_008:out_0_error -> REG_BUTTON_s1_agent:rdata_fifo_sink_error
	...
	reloj_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (CLK_clk_clk),                              //       clk.clk
		.reset               (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
