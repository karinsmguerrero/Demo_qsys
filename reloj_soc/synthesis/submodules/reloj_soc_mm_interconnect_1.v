...
module reloj_soc_mm_interconnect_1 (
		...
		output wire [10:0] RAM_s2_address,                                                    //                                                      RAM_s2.address
	...
	wire   [20:0] ram_s2_agent_m0_address;                                // RAM_s2_agent:m0_address -> RAM_s2_translator:uav_address
	...
	wire  [112:0] ram_s2_agent_rf_source_data;                            // RAM_s2_agent:rf_source_data -> RAM_s2_agent_rsp_fifo:in_data
	...
	wire  [112:0] ram_s2_agent_rsp_fifo_out_data;                         // RAM_s2_agent_rsp_fifo:out_data -> RAM_s2_agent:rf_sink_data
	...
	wire          ram_s2_agent_rdata_fifo_src_valid;                      // RAM_s2_agent:rdata_fifo_src_valid -> RAM_s2_agent_rdata_fifo:in_valid
	wire   [33:0] ram_s2_agent_rdata_fifo_src_data;                       // RAM_s2_agent:rdata_fifo_src_data -> RAM_s2_agent_rdata_fifo:in_data
	wire          ram_s2_agent_rdata_fifo_src_ready;                      // RAM_s2_agent_rdata_fifo:in_ready -> RAM_s2_agent:rdata_fifo_src_ready
	...
	wire          ram_s2_agent_rp_valid;                                  // RAM_s2_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] ram_s2_agent_rp_data;                                   // RAM_s2_agent:rp_data -> router_003:sink_data
	wire          ram_s2_agent_rp_ready;                                  // router_003:sink_ready -> RAM_s2_agent:rp_ready
	wire          ram_s2_agent_rp_startofpacket;                          // RAM_s2_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          ram_s2_agent_rp_endofpacket;                            // RAM_s2_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                  // cmd_mux_001:src_valid -> RAM_s2_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                   // cmd_mux_001:src_data -> RAM_s2_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                  // RAM_s2_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                // cmd_mux_001:src_channel -> RAM_s2_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                          // cmd_mux_001:src_startofpacket -> RAM_s2_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                            // cmd_mux_001:src_endofpacket -> RAM_s2_burst_adapter:sink0_endofpacket
	wire          ram_s2_burst_adapter_source0_valid;                     // RAM_s2_burst_adapter:source0_valid -> RAM_s2_agent:cp_valid
	wire  [111:0] ram_s2_burst_adapter_source0_data;                      // RAM_s2_burst_adapter:source0_data -> RAM_s2_agent:cp_data
	wire          ram_s2_burst_adapter_source0_ready;                     // RAM_s2_agent:cp_ready -> RAM_s2_burst_adapter:source0_ready
	wire    [1:0] ram_s2_burst_adapter_source0_channel;                   // RAM_s2_burst_adapter:source0_channel -> RAM_s2_agent:cp_channel
	wire          ram_s2_burst_adapter_source0_startofpacket;             // RAM_s2_burst_adapter:source0_startofpacket -> RAM_s2_agent:cp_startofpacket
	wire          ram_s2_burst_adapter_source0_endofpacket;               // RAM_s2_burst_adapter:source0_endofpacket -> RAM_s2_agent:cp_endofpacket
	...
	wire          ram_s2_agent_rdata_fifo_out_valid;                      // RAM_s2_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] ram_s2_agent_rdata_fifo_out_data;                       // RAM_s2_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          ram_s2_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_001:in_0_ready -> RAM_s2_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                      // avalon_st_adapter_001:out_0_valid -> RAM_s2_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                       // avalon_st_adapter_001:out_0_data -> RAM_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                      // RAM_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                      // avalon_st_adapter_001:out_0_error -> RAM_s2_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (ram_s2_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (ram_s2_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (ram_s2_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (ram_s2_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (ram_s2_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (ram_s2_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ram_s2_agent_rdata_fifo (
		.clk               (CLK_clk_clk),                               //       clk.clk
		.reset             (FIFO_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (ram_s2_agent_rdata_fifo_src_data),          //        in.data
		.in_valid          (ram_s2_agent_rdata_fifo_src_valid),         //          .valid
		.in_ready          (ram_s2_agent_rdata_fifo_src_ready),         //          .ready
		.out_data          (ram_s2_agent_rdata_fifo_out_data),          //       out.data
		.out_valid         (ram_s2_agent_rdata_fifo_out_valid),         //          .valid
		.out_ready         (ram_s2_agent_rdata_fifo_out_ready),         //          .ready
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (ram_s2_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (ram_s2_burst_adapter_source0_data),          //          .data
		.source0_channel       (ram_s2_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (ram_s2_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (ram_s2_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (ram_s2_burst_adapter_source0_ready)          //          .ready
	);
	...
	reloj_soc_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (CLK_clk_clk),                               //       clk.clk
		.reset               (FIFO_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	reloj_soc_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (CLK_clk_clk),                               //       clk.clk
		.reset              (FIFO_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	reloj_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (CLK_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (FIFO_reset_in_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ram_s2_agent_rdata_fifo_out_data),          //     in_0.data
		.in_0_valid     (ram_s2_agent_rdata_fifo_out_valid),         //         .valid
		.in_0_ready     (ram_s2_agent_rdata_fifo_out_ready),         //         .ready
